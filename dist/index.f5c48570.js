...
const controlGetMovio = async function(cinema) {
    await _modelJs.getMovio(cinema);
};
async function showMovie(cinema) {
    await controlGetMovio(cinema);
    const data = _modelJs.state.data.Search;
    console.log(data);
    _viewJsDefault.default.render(data);
}
_viewJsDefault.default.addHandleEvent(showMovie);

},{"regenerator-runtime":"dXNgZ","./model.js":"dEDha","./view.js":"ai2uB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dXNgZ":[function(require,module,exports) {
/**
...
parcelHelpers.export(exports, "getMovio", ()=>getMovio
);
const state = {
    data: {}
};
const getMovio = async function(movieName) {
    try {
        const dataJson = await fetch(`https://omdbapi.com/?s=${movieName}&page=1&apikey=fc1fef96`);
        state.data = await dataJson.json();
        console.log(state.data);
    } catch (err) {
        alert(err);
...
exports.default = new ViewMovio();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gp8pR","8ZNvh"], "8ZNvh", "parcelRequire47ec")
